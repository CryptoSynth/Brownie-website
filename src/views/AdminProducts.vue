<template>
  <v-container fluid>
    <v-row align="center" justify="center" no-gutters>
      <v-col cols="12">
        <v-sheet color="red accent-2 pa-2">
          <v-data-table
            light
            :headers="headers"
            :items="products"
              ...
              <v-toolbar light flat color="pink accent-3">
                ...
                <v-dialog v-model="dialog" max-width="700px">
                  <template v-slot:activator="{ on }">
                    <v-btn rounded color="green accent-3" light class="mb-2" v-on="on">
                  ...
                  <v-card>
                    ...
                    <v-card-actions>
                      ...
                      <v-btn color="green accent-3" text @click="save(editedItem)">Save</v-btn>
                    </v-card-actions>
                  </v-card>
                </v-dialog>
              </v-toolbar>
